...
#-- operations
    ...
    def do_put(self, data):
        ...
        if remotefile[0] != '/':
            remotefile = f'{self.cwd}/{remotefile}'
    ...
    def do_cp(self, data):
        ...
        if srcfile[0] != '/':
            srcfile = f'{self.cwd}/{srcfile}'
        if destfile[0] != '/':
            destfile = f'{self.cwd}/{destfile}'
    ...
    def do_rename(self, data):
        ...
        if srcname[0] != '/':
            srcname = f'{self.cwd}/{srcname}'
        if destname[0] != '/':
            destname = f'{self.cwd}/{destname}'
